<?php
	...
	**/
	...
	class LocalLRUTest extends PHPUnit_Framework_TestCase
	{
		function testUnlimited()
		{
			$c = new LayerCache_Cache_LocalLRU();
		...
		{
			$c = new LayerCache_Cache_LocalLRU(0, 2);
		...
		{
			$c = new LayerCache_Cache_LocalLRU(10, 0);
			$this->assertSame(null, $c->read('a'));
